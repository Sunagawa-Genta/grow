...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Grow</h2>
    ...
    <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
      ...
      <a href="#" class="group relative flex h-48 flex-col overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-64 xl:h-96">
        ...
        <div class="relative mt-auto p-4">
          ...
          <span class="font-semibold text-indigo-300">click</span>
        </div>
      </a>
      <!-- article - end -->
      ...
      <a href="#" class="group relative flex h-48 flex-col overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-64 xl:h-96">
        ...
        <div class="relative mt-auto p-4">
          <span class="block text-sm text-gray-200">my goal</span>
          <h2 class="mb-2 text-xl font-semibold text-white transition duration-100">目標</h2>
