      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white dark:bg-gray-800 border-b border-grey-200 dark:border-gray-800">
          <table class="text-center w-full border-collapse">
            <thead>
              <tr>
                <th class="py-4 px-6 bg-gray-lightest dark:bg-gray-darkest font-bold uppercase text-lg text-gray-dark dark:text-gray-200 border-b border-grey-light dark:border-grey-dark">目標</th>
              </tr>
            </thead>
            <tbody>
                  ...
                  <div class="flex">
                    ...
                    <form action="{{ route('unfinishes',$goal) }}" method="POST" class="text-left">
                      ...
                      <x-primary-button class="ml-3">
                        <svg class="h-6 w-6 text-yellow-400"  fill="yellow" viewBox="0 0 24 24" stroke="currentColor">
